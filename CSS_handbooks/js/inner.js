...
var Global = {
	//在线手册根目录，默认值
	rootPath: "http://css.hungking.com",
	//是否chm浏览方式
...
(function(){
	...
	(function (){
		...
		'<div class="g-browser g-clear">'+
			'<ul>'+
				'<li><a href="https://github.com/hungking/css-handbook/issues" target="_blank" rel="external" class="external">Issues</a></li>'+
				'<li><a href="https://github.com/hungking/css-handbook/pulls" target="_blank" rel="external" class="external">Pull Requests</a></li>'+
			'</ul>'+
		...
		var copyright = '<p class="copyright">Copyright © 2006-'+ new Date().getFullYear() +' <a href="http://www.hungking.cc/" rel="external" target="_blank">hungking</a>. All Rights Reserved</p>'
